/*
 ...
 20091204 cyphunk <cyphunk@gmail.com>: initial port of
 Lekernels arduinull [1].
 20091210 cyphunk: added loopback check, shiftDR routines
 20091218 cyphunk: added idcode, boundary, ir scan routines
