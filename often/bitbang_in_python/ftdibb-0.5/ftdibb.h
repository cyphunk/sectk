...
//
// reset the chip or purge Tx/Rx, what=0 means reset sio, what=1 means purge Rx, what=2 means purge Tx
extern int ftdibb_reset(usb_dev_handle *dev_handle,unsigned char what);
