...
class CookieCleaner:
    ...
    def getExpireCookieStringFor(self, cookie, host, domain, path):
        ...
        expireStrings.append("Set-Cookie: " + cookie + "=" + "EXPIRED;Path=/;Domain=" + domain + 
                             ";Expires=Mon, 01-Jan-1990 00:00:00 GMT\r\n")

        expireStrings.append("Set-Cookie: " + cookie + "=" + "EXPIRED;Path=/;Domain=" + host + 
                             ";Expires=Mon, 01-Jan-1990 00:00:00 GMT\r\n")

        if len(pathList) > 2:
            expireStrings.append("Set-Cookie: " + cookie + "=" + "EXPIRED;Path=/" + pathList[1] + ";Domain=" +
